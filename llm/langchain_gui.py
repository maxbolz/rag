...
with tab1:
    ...
    with col1:
        ...
        db_input = st.text_input("Database", placeholder="Enter database name or string", key="db_input")
    with col2:
    ...
    if run_button:
        if user_input:
            ...
            # Pass db_input as a param
            result = controller.answer_question(user_input, database=db_input)
